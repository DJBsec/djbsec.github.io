...
<div class="news-filter-bar">
  {% for tag in site.display_tags %}
    <a class="news-pill" href="{{ tag | slugify | prepend: '/cybernews/tag/' | relative_url }}">
      <i class="fa-solid fa-hashtag fa-xs"></i> {{ tag }}
    </a>
  {% endfor %}
  {% for category in site.display_categories %}
    <a class="news-pill news-pill--category" href="{{ category | slugify | prepend: '/cybernews/category/' | relative_url }}">
